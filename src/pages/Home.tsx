...
export default function Home() {
  ...
  const ServiceCard = ({ 
    ...
    <motion.div
      ...
      className={`service-card ${className} bg-white dark:bg-gray-800 rounded-2xl shadow-lg dark:shadow-md shadow-gray-300 dark:shadow-none flex flex-col p-6 text-center cursor-pointer`}
    >
