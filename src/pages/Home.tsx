...
export default function Home() {
  ...
  const ServiceCard = ({ 
    ...
    <motion.div
      ...
      className={`service-card ${className} bg-gray-50 dark:bg-gray-800 rounded-2xl shadow-lg dark:shadow-md shadow-gray-300 dark:shadow-none flex flex-col p-6 text-center cursor-pointer`}
    >
      ...
      <a
        href={path}
        className="mt-auto px-6 py-2.5 rounded-xl font-medium text-white shadow-sm transition-colors duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 inline-block"
        style={{ 
