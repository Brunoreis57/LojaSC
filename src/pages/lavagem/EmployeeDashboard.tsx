...
const mockAppointments = [
  { id: '1', client: 'João Silva', vehicle: 'Toyota Corolla - ABC1234', time: '09:30', date: '2023-10-20', service: 'Lavagem Completa', status: 'confirmado' },
  { id: '2', client: 'Maria Oliveira', vehicle: 'Honda Civic - DEF5678', time: '10:45', date: '2023-10-20', service: 'Lavagem Rápida', status: 'pendente' },
  { id: '3', client: 'Pedro Santos', vehicle: 'Volkswagen Golf - GHI9012', time: '14:15', date: '2023-10-20', service: 'Polimento', status: 'confirmado' },
];
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {activeTab === 'schedule' && (
          <div className="grid grid-cols-1 gap-6">
            <Card title="Agendamentos do Dia" serviceType="lavagem">
                ...
                {mockAppointments.map((appointment) => (
                  ...
                  >
                    ...
                    <div className="mt-4 flex justify-end">
                      <Button size="sm" serviceType="lavagem">
                        Iniciar Serviço
                      </Button>
                    </div>
                  </div>
        ...
        {activeTab === 'vehicles' && (
          <div className="grid grid-cols-1 gap-6">
            <Card title="Veículos em Atendimento" serviceType="lavagem">
              <div className="space-y-4">
                {mockVehicles.map((vehicle) => (
                  ...
                  >
                    ...
                    <div className="mt-4 flex justify-end space-x-2">
                      <Link to={`/lavagem/checklist/${vehicle.id}`}>
                      ...
                      {vehicle.status !== 'Finalizado' && (
                        <Button size="sm" serviceType="lavagem" icon={<CheckCircle className="w-4 h-4" />}>
        ...
        {activeTab === 'checklists' && (
          <div className="grid grid-cols-1 gap-6">
            <Card title="Checklists de Veículos" serviceType="lavagem">
              <div className="mb-4">
                <p className="text-gray-600 dark:text-gray-400">
                  Crie e gerencie checklists para os veículos dos clientes. Documente o estado do veículo, danos, e o que precisa ser feito.
                </p>
              </div>
                ...
                {mockVehicles.map((vehicle) => (
                  ...
                  >
                    <div className="flex justify-between items-start">
                      ...
                      <Link 
                        to={`/lavagem/checklist/${vehicle.id}`}
